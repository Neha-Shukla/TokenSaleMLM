      ...
      <img src={require('../../assets/images/logo.png')} alt="logo" />
        ...
        {income?.data?.tokensReceived &&
          <div className="text-md-center ">
            ...
            <button className="btn btn-outline-light btn-rounded get-started-btn" style={{marginRight: "10px"}} type="button" >{income?.data?.referrer ? income?.data?.referrer : ""}</button>
